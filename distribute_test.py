...
def main(_):
	...
	task_type = task_config.get('type')     # ps or worker
	...
	ps_hosts = cluster_config.get('ps')         # ["10.233.113.70:2222"]
	worker_hosts = cluster_config.get('worker') # ["10.233.112.166:2223","10.233.91.193:2223"]

	ps_hosts_str = ','.join(ps_hosts)           # 10.233.113.70:2222
	worker_hosts_str = ','.join(worker_hosts)   # 10.233.112.166:2223,10.233.91.193:2223
